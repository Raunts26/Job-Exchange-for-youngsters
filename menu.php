...
<!--
<?php if($page_file != "shadow.php") { ?>
<li><a href="<?=$myurl; ?>content/shadow.php">Töövarjupäev</a></li>
<?php } else { ?>
<li class="active"><a href="<?=$myurl; ?>content/shadow.php">Töövarjupäev</a></li>
<?php } ?>
-->
	...
	<li class="dropdown">
	  ...
	  <ul class="dropdown-menu">
	   ...
	   <li role="separator" class="divider"></li>
			...
			<?php if($page_file != "newshadow.php") { ?>
			<li><a href="<?=$myurl; ?>admin/newshadow.php">Uus töövari</a></li>
			<?php } else { ?>
			<li class="active"><a href="<?=$myurl; ?>admin/newshadow.php">Uus töövari</a></li>
			<?php } ?>
			...
			<?php if($page_file != "editshadows.php") { ?>
			<li><a href="<?=$myurl; ?>admin/editshadows.php">Muuda töövarje</a></li>
			<?php } else { ?>
			<li class="active"><a href="<?=$myurl; ?>admin/editshadows.php">Muuda töövarje</a></li>
			<?php } ?>
