...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
      ...
      <link href="<?php $_SERVER['DOCUMENT_ROOT']; ?>/ntb/css/bootstrap.css" rel="stylesheet">
  ...
  <div class="logoback">
    ...
    <span class="version" style="position: absolute;padding-left: 105px;color: rgb(147, 108, 148);top: 0px;">v0.5.0</span>
  </div>
